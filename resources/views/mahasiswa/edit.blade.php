        ...
        <div class="container " style="padding-top:7%;">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='destinasi' value="{{ $mahasiswa->destinasi }}" id="destinasi">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="nama" class="col-sm-2 col-form-label">Tanggal Berangkat</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='tanggal' value="{{ $mahasiswa->tanggal }}" id="tanggal">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="jurusan" class="col-sm-2 col-form-label">Budget</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='budget' value="{{ $mahasiswa->budget }}" id="budget">
                    </div>
                </div>
                <div class="mb-3 row">
                  <label for="gambar" class="col-sm-2 col-form-label">Gambar</label>
                  <div class="col-sm-10">
                      <input type="file" class="form-control" name='gambar' id="gambar" accept="image/" onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])"> <div class="mt-3 mx-4"><img src="{{ asset($mahasiswa->gambar) }}" id="output" width="300"></div>
                  @error('gambar')
